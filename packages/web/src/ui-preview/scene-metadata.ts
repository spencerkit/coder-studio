...
function lightThemeIds(): UiPreviewSceneTheme[] {
  return THEME_IDS.filter((themeId) => themeId.endsWith("-light")) as UiPreviewSceneTheme[];
}
...
export const UI_PREVIEW_SCENE_METADATA: UiPreviewSceneMetadata[] = [
  ...
  },
  {
    ...
    category: "page",
    source: "showcase",
    description: "Desktop topbar chrome review with seeded workspaces and quick actions.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--topbar" },
  },
  {
    id: "workspace-sidebar-files-review",
    title: "Workspace / Sidebar Files Review",
    category: "page",
    source: "showcase",
    description: "Desktop file tree sidebar review with seeded search and file hierarchy.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--sidebar" },
  },
  {
    id: "workspace-sidebar-git-review",
    title: "Workspace / Sidebar Git Review",
    category: "page",
    source: "showcase",
    description: "Desktop git sidebar review with seeded status, history, and worktrees.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--sidebar" },
  ...
  {
    id: "workspace-editor-review",
    title: "Workspace / Editor Review",
    category: "page",
    source: "showcase",
    description: "Desktop editor review with code chrome, dirty state, and static content density.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--editor" },
  },
  {
    id: "workspace-diff-review",
    title: "Workspace / Diff Review",
    category: "page",
    source: "showcase",
    description: "Desktop diff review with populated git preview lines and editor-surface chrome.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--diff" },
  },
  {
    id: "workspace-terminal-empty-review",
    title: "Workspace / Terminal Empty Review",
    category: "empty",
    source: "showcase",
    description: "Desktop terminal empty state review for bottom panel density and hierarchy.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--terminal" },
  },
  {
    id: "settings-density-review",
    title: "Settings / Density Review",
    category: "page",
    source: "showcase",
    description: "Desktop settings page review for spacing, grouping, and information density.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".settings-page" },
  },
  {
    id: "settings-light-theme-review",
    title: "Settings / Light Theme Review",
    category: "page",
    source: "showcase",
    description:
      "Desktop settings review constrained to light themes for surface hierarchy checks.",
    devices: ["desktop"],
    themes: lightThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".settings-page" },
  },
  {
    id: "desktop-overlay-review",
    title: "Desktop / Overlay Review",
    category: "modal",
    source: "showcase",
    description: "Desktop overlay comparison for command palette, launcher, and worktree manager.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-grid" },
  },
  {
    id: "desktop-statusbar-review",
    title: "Desktop / Status Bar Review",
    category: "page",
    source: "showcase",
    description: "Desktop status bar review with seeded branch and file-change state.",
    devices: ["desktop"],
    themes: allThemeIds(),
    locales: ["zh", "en"],
    capture: { selector: ".desktop-review-card--statusbar" },
  },
  {
    id: "worktree-manager",
