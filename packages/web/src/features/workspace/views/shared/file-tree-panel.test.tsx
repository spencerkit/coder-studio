...
describe("FileTreePanel", () => {
  ...
  it("renders the create dialog close action with icon button compatibility classes", async () => {
    ...
    expect(await screen.findByRole("button", { name: "action.close" })).toHaveClass(
      "btn",
      "btn-ghost",
      "btn-sm"
    );
