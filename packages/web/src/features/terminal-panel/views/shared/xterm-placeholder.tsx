...
export const XtermPlaceholder: FC<XtermPlaceholderProps> = ({ state, queuePosition }) => {
  ...
  return (
    <div className="xterm-replay-overlay xterm-replay-overlay--placeholder" role="status" aria-live="polite">
      <div className="xterm-replay-overlay__card">
        {state === 'granting' ? <div className="xterm-replay-overlay__spinner" aria-hidden="true" /> : null}
