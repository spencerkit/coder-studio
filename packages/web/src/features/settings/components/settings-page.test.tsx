...
describe("SettingsPage", () => {
  ...
  it("shows an explicit error when settings loading fails", async () => {
    ...
    expect(screen.getByRole("alert")).toHaveClass("settings-page__notice");
    const notice = document.querySelector(".settings-page__notice");
    expect(notice).toHaveClass("settings-page__notice", "settings-page__notice--error");
  ...
  it("renders appearance selectors with shared pill compatibility classes", async () => {
    ...
    expect(standardRendererPill).toHaveClass("settings-pill", "settings-pill-active");
    expect(standardRendererPill).toHaveAttribute("aria-pressed", "true");
    expect(chineseLanguagePill).toHaveClass("settings-pill", "settings-pill-active");
