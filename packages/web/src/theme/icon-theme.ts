...
export const ICON_SEMANTICS = [
  ...
  "nav.skills",
  "nav.extensions",
  "skill.metric.installs",
  "skill.metric.githubStars",
  "mobile.dock.agent",
  "mobile.dock.files",
  ...
  "nav.settings.monitoring",
  "nav.settings.about",
  "nav.settings.diagnostics",
  "nav.settings.analysis",
  "terminal.action.new",
...
export const BASE_ICON_THEME: IconThemeDefinition = {
  icons: {
    ...
    "nav.workspaceMenu": { glyph: LayoutGrid, tone: "secondary" },
    "nav.explorer": { glyph: FolderTree, tone: "secondary" },
    "nav.search": { glyph: Search, tone: "secondary" },
    "nav.sourceControl": { glyph: GitBranch, tone: "secondary" },
    ...
    "nav.memory": { glyph: FileText, tone: "secondary" },
    "nav.skills": { glyph: Package, tone: "current" },
    "nav.extensions": { glyph: Puzzle, tone: "current" },
    "skill.metric.installs": { glyph: Download, tone: "muted" },
    "skill.metric.githubStars": { glyph: Star, tone: "warning" },
