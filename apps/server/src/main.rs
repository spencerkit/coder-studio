...
pub(crate) use models::{
    ...
    GitFileDiffPayload, GitStatus, IdlePolicy, SessionInfo, SessionMessage, SessionMessageRole,
    SessionMode, SessionPatch, SessionStatus, TargetClaudeOverride, TerminalEvent, TerminalInfo,
