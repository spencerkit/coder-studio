...
const messages = {
  en: {
    ...
    codexSettingsHint: "Configure Codex launch profiles and target overrides using the same global/native/WSL structure.",
    ...
    codexScopeGlobal: "Global",
    codexScopeNative: "Native",
    codexScopeWsl: "WSL",
    codexOverrideEnabled: "Override enabled",
    codexOverrideInherited: "Inheriting global settings",
    codexCommandPreview: "Launch preview",
    codexCommandPreviewHint: "This is the exact Codex CLI command that will run for the selected scope, including generated --config overrides.",
    codexExecutable: "Executable",
    codexExecutableHint: "Path or command name used to launch Codex in this scope.",
    codexExtraArgs: "Extra startup args",
    codexExtraArgsHint: "One CLI token per line. Use this for flags not already covered by the structured config fields below.",
    codexExtraArgsMeta: "One CLI token per line · Example: --full-auto",
    codexExtraArgsPlaceholder: "--full-auto\n--search",
    codexConfigSection: "Structured Config",
    codexConfigSectionHint: "These fields are appended as --config key=value overrides at launch time, without requiring edits to your global Codex files.",
    codexModel: "Model",
    codexModelHint: "Top-level model override passed through to Codex.",
    codexModelPlaceholder: "gpt-5.4",
    codexApprovalPolicy: "Approval policy",
    codexApprovalPolicyHint: "Top-level approval_policy override.",
    codexSandboxMode: "Sandbox mode",
    codexSandboxModeHint: "Top-level sandbox_mode override.",
    codexWebSearch: "Web search",
    codexWebSearchHint: "Top-level web_search override.",
    codexReasoningEffort: "Reasoning effort",
    codexReasoningEffortHint: "Top-level model_reasoning_effort override.",
    codexSelectUnsetOption: "Inherit / unset",
    codexApprovalPolicyUntrustedOption: "untrusted",
    codexApprovalPolicyOnRequestOption: "on-request",
    codexApprovalPolicyNeverOption: "never",
    codexSandboxReadOnlyOption: "read-only",
    codexSandboxWorkspaceWriteOption: "workspace-write",
    codexSandboxDangerFullAccessOption: "danger-full-access",
    codexWebSearchDisabledOption: "disabled",
    codexWebSearchCachedOption: "cached",
    codexWebSearchLiveOption: "live",
    codexReasoningMinimalOption: "minimal",
    codexReasoningLowOption: "low",
    codexReasoningMediumOption: "medium",
    codexReasoningHighOption: "high",
    codexReasoningXhighOption: "xhigh",
    codexExtraEnv: "Extra environment",
    codexExtraEnvHint: "Additional environment variables passed through to Codex for this scope.",
    codexExtraEnvMeta: "KEY=VALUE per line · Example: OPENAI_API_KEY=sk-...",
    codexExtraEnvPlaceholder: "OPENAI_API_KEY=sk-...\nHTTP_PROXY=http://127.0.0.1:7890",
  ...
  zh: {
    ...
    codexSettingsTitle: "Codex",
    codexSettingsHint: "按全局 / Native / WSL 三层结构配置 Codex 的启动参数和目标覆盖项。",
    ...
    codexScopeNative: "Native",
    codexScopeWsl: "WSL",
    codexOverrideEnabled: "已启用覆盖",
    codexOverrideInherited: "继承全局设置",
    codexCommandPreview: "启动预览",
    codexCommandPreviewHint: "这里展示当前 scope 下最终会执行的 Codex CLI 命令，包含自动追加的 --config 覆盖参数。",
    codexExecutable: "可执行文件",
    codexExecutableHint: "当前 scope 下用于启动 Codex 的命令或完整路径。",
    codexExtraArgs: "额外启动参数",
    codexExtraArgsHint: "每行一个 CLI 参数，用于补充下面结构化配置里没有覆盖到的启动参数。",
    codexExtraArgsMeta: "每行一个 CLI 参数 · 例如：--full-auto",
    codexExtraArgsPlaceholder: "--full-auto\n--search",
    codexConfigSection: "结构化配置",
    codexConfigSectionHint: "这些字段会在启动时追加为 --config key=value 覆盖项，不需要直接修改你的全局 Codex 配置文件。",
    codexModel: "模型",
    codexModelHint: "传给 Codex 的顶层 model 覆盖项。",
    codexModelPlaceholder: "gpt-5.4",
    codexApprovalPolicy: "审批策略",
    codexApprovalPolicyHint: "顶层 approval_policy 覆盖项。",
    codexSandboxMode: "沙箱模式",
    codexSandboxModeHint: "顶层 sandbox_mode 覆盖项。",
    codexWebSearch: "联网搜索",
    codexWebSearchHint: "顶层 web_search 覆盖项。",
    codexReasoningEffort: "推理强度",
    codexReasoningEffortHint: "顶层 model_reasoning_effort 覆盖项。",
    codexSelectUnsetOption: "继承 / 不设置",
    codexApprovalPolicyUntrustedOption: "untrusted",
    codexApprovalPolicyOnRequestOption: "on-request",
    codexApprovalPolicyNeverOption: "never",
    codexSandboxReadOnlyOption: "read-only",
    ...
    codexReasoningHighOption: "high",
    codexReasoningXhighOption: "xhigh",
    codexExtraEnv: "额外环境变量",
    codexExtraEnvHint: "为当前 scope 传递给 Codex 的附加环境变量。",
    codexExtraEnvMeta: "每行一个 KEY=VALUE · 例如：OPENAI_API_KEY=sk-...",
    codexExtraEnvPlaceholder: "OPENAI_API_KEY=sk-...\nHTTP_PROXY=http://127.0.0.1:7890",
