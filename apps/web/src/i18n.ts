...
const messages = {
  en: {
    ...
    codexCommandPreviewHint: "This is the exact Codex CLI command that will run in the current runtime, including generated --config overrides.",
    ...
    codexExtraEnvHint: "Additional environment variables passed through to Codex in the current runtime.",
  ...
  zh: {
    ...
    codexCommandPreviewHint: "这里展示当前运行环境下最终会执行的 Codex CLI 命令，包含自动追加的 --config 覆盖参数。",
    ...
    codexExtraEnvHint: "传递给当前运行环境下 Codex 的附加环境变量。",
