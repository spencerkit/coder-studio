...
const messages = {
  en: {
    ...
    claudeSettingsHint: "Configure the Claude runtime, per-target overrides, and advanced config files from one place.",
  ...
  zh: {
    ...
    claudeSettingsTitle: "Claude",
    claudeSettingsHint: "统一配置 Claude 运行时、目标覆盖配置，以及底层配置文件。",
